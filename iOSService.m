...
-(void)categorySync:(NSString *)user :(NSString *)pass :(NSString *)clientCategoryID :(NSString *)serverCategoryID :(int)categoryType :(NSString *)categoryName :(NSString *)categoryColor :(NSString *)categoryStatus {
    NSMutableString *params = [NSMutableString string];
    [params appendString:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body>"];
    [params appendString:@"<categorySync xmlns=\"urn:iOSService\">"];
    [params appendFormat:@"<user>%@</user>" , user];
    [params appendFormat:@"<pass>%@</pass>" , pass];
    [params appendFormat:@"<clientCategoryID>%@</clientCategoryID>" , clientCategoryID];
    [params appendFormat:@"<serverCategoryID>%@</serverCategoryID>" , serverCategoryID];
    ...
    [params appendFormat:@"<categoryStatus>%@</categoryStatus>" , categoryStatus];
    [params appendString:@"</categorySync>"];
    [params appendString:@"</soap:Body></soap:Envelope>"];
    NSURL *onwURL = [[NSURL alloc] initWithString:[self url]];
    NSMutableURLRequest *onwreq = [NSMutableURLRequest requestWithURL:onwURL cachePolicy:NSURLRequestReloadIgnoringLocalAndRemoteCacheData timeoutInterval:30.0];
    NSString *messageLen = [NSString stringWithFormat:@"%d", [params length]];
    [onwreq addValue:[onwURL host] forHTTPHeaderField:@"Host"];
    [onwreq addValue:@"urn:iOSService/categorySync" forHTTPHeaderField:@"SOAPAction"];
    [onwreq addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [onwreq addValue:messageLen forHTTPHeaderField:@"Content-Length"];
    [onwreq setHTTPMethod:@"POST"];
    [onwreq setHTTPBody:[params dataUsingEncoding:NSUTF8StringEncoding]];
    ...
    self.wsConnection = [[NSURLConnection alloc] initWithRequest:onwreq delegate:self];
    [self setEventName:@"urn:iOSServicecategorySyncDidFinish"];
}
...
-(void)itemSync:(NSString *)user :(NSString *)pass :(NSString *)categoryID :(NSString *)categoryName :(NSString *)categoryColor {
    NSMutableString *params = [NSMutableString string];
    [params appendString:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body>"];
    [params appendString:@"<itemSync xmlns=\"urn:iOSService\">"];
    [params appendFormat:@"<user>%@</user>" , user];
    [params appendFormat:@"<pass>%@</pass>" , pass];
    [params appendFormat:@"<categoryID>%@</categoryID>" , categoryID];
    [params appendFormat:@"<categoryName>%@</categoryName>" , categoryName];
    [params appendFormat:@"<categoryColor>%@</categoryColor>" , categoryColor];
    [params appendString:@"</itemSync>"];
    [params appendString:@"</soap:Body></soap:Envelope>"];
    NSURL *onwURL = [[NSURL alloc] initWithString:[self url]];
    NSMutableURLRequest *onwreq = [NSMutableURLRequest requestWithURL:onwURL cachePolicy:NSURLRequestReloadIgnoringLocalAndRemoteCacheData timeoutInterval:30.0];
    NSString *messageLen = [NSString stringWithFormat:@"%d", [params length]];
    [onwreq addValue:[onwURL host] forHTTPHeaderField:@"Host"];
    [onwreq addValue:@"urn:iOSService/itemSync" forHTTPHeaderField:@"SOAPAction"];
    [onwreq addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [onwreq addValue:messageLen forHTTPHeaderField:@"Content-Length"];
    [onwreq setHTTPMethod:@"POST"];
    [onwreq setHTTPBody:[params dataUsingEncoding:NSUTF8StringEncoding]];
    ...
    self.wsConnection = [[NSURLConnection alloc] initWithRequest:onwreq delegate:self];
    [self setEventName:@"urn:iOSServiceitemSyncDidFinish"];
}
